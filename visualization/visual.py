...
# Plot routs.
route_coords = greedy_routing()

for cr in range(0, len(route_coords)):
    route_lat, route_lon = [el[0] for el in route_coords[cr]], [el[1] for el in route_coords[cr]]
    p.line(route_lon, route_lat, line_width=4, color=colors[cr])


# Plot the START point
start_lon, start_lat = route_coords[0][0][0], route_coords[0][0][1]
